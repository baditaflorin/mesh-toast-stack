...
git clone https://github.com/baditaflorin/mesh-toast-stack
cd mesh-toast-stack
npm install
npm run dev
```
...
- `mesh-toast-stack:signalingUrl`
- `mesh-toast-stack:turnTokenUrl`
- `mesh-toast-stack:iceServers`
- `mesh-toast-stack:room`
